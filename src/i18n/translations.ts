...
export const translations = {
  ...
  about: {
    ...
    p1: {
      en: "Mario Bencomo is a full-stack web developer focused on building scalable and efficient applications. He turns ideas into optimized digital products with clean code and a great user experience.",
      es: "Mario Bencomo es un desarrollador full stack enfocado en construir aplicaciones web escalables y eficientes. Transforma ideas en productos digitales optimizados, con código limpio y una gran experiencia de usuario.",
    },
    p2: {
      en: "Beyond building web solutions, Mario dedicates time to the gym, training discipline and consistency. The same energy applied to every repetition is channeled into every line of code.",
      es: "Más allá de crear soluciones web, Mario dedica tiempo al gimnasio, entrenando disciplina y constancia. La misma energía aplicada en cada repetición se canaliza en cada línea de código.",
    },
    degree: {
  ...
  education: {
    ...
    degree: {
      ...
      focus: {
        en: "Focused on software engineering fundamentals and modern web technologies. Recent work includes the development of a full-stack project implementing structured architecture and database management as part of the 4th-semester core curriculum.",
        es: "Enfoque en fundamentos de ingeniería de software y tecnologías web modernas. El trabajo reciente incluye el desarrollo de un proyecto full-stack implementando arquitectura estructurada y gestión de bases de datos como parte del plan de estudios del 4to semestre.",
      },
    },
  },
  experience: {
    ...
    responsibilities: {
      en: [
        "Develops responsive and modern web applications",
        "Builds real-world projects using React and TailwindCSS",
        "Focuses on clean code and performance optimization",
        "Designs user-friendly and visually appealing interfaces",
        "Continuously learns and improves technical skills",
      ],
      es: [
        "Desarrolla aplicaciones web responsivas y modernas",
        "Crea proyectos del mundo real usando React y TailwindCSS",
        "Se enfoca en código limpio y optimización de rendimiento",
        "Diseña interfaces amigables y visualmente atractivas",
        "Aprende y mejora continuamente sus habilidades técnicas",
      ],
    },
  },
  projects: {
    ...
    project1: {
      ...
      solutions: {
        en: [
          "Design of a modern, mobile-first interface",
          "Structuring of service categories for clarity",
          "Implementation of responsive and optimized layout",
          "Focus on performance and clean architecture",
          "Building of scalable and maintainable code structure",
        ],
        es: [
          "Diseño de una interfaz moderna mobile-first",
          "Estructuración de las categorías de servicios para claridad",
          "Implementación de un layout responsivo y optimizado",
          "Enfoque en rendimiento y arquitectura limpia",
          "Construcción de una estructura de código escalable y mantenible",
        ],
      },
    ...
    project2: {
      ...
      solutions: {
        en: [
          "Development of a high-performance landing page using Vite and TypeScript to ensure instant loading and a smooth user experience.",
          "Design of a catalog of transparent services and prices that segments the offer into scalable packages (Essential, Studio, Pro) with delivery times starting from 1 business day.",
          "Implementation of a dynamic portfolio exhibition system to detail success stories like 'Smart Travel Genie' and 'Radiant Beauty Studio', highlighting technologies and results.",
          "Integration of lead generation flows through strategic calls to action (CTA) to schedule 30-minute discovery sessions.",
        ],
        es: [
          "Desarrollo de una landing page de alto rendimiento utilizando Vite y TypeScript para garantizar una carga instantánea y una experiencia de usuario fluida.",
          "Diseño de un catálogo de servicios y precios transparentes que segmenta la oferta en paquetes escalables (Essential, Studio, Pro) con tiempos de entrega desde 1 día hábil.",
          "Implementación de un sistema de exhibición de portafolio dinámico para detallar casos de éxito como 'Smart Travel Genie' y 'Radiant Beauty Studio', resaltando tecnologías y resultados.",
          "Integración de flujos de generación de leads mediante llamadas a la acción (CTA) estratégicas para agendar sesiones de descubrimiento de 30 minutos.",
        ],
      },
      impactTitle: { en: "Impact / Results", es: "Impacto / Resultados" },
      impacts: {
    ...
    project3: {
      ...
      solutions: {
        en: [
          "Implementation of Playwright for real-time web scraping on Google Flights and Airbnb, avoiding the use of static databases.",
          "Integration of Google Gemini Pro as the decision engine to filter and match the best flight and accommodation combos based on budget in MXN.",
          "Development of a chat assistant (Pre-planner) and a dynamic itinerary generator based on intelligent geolocation.",
        ],
        es: [
          "Implementación de Playwright para realizar web scraping en tiempo real sobre Google Flights y Airbnb, evitando el uso de bases de datos estáticas.",
          "Integración de Google Gemini Pro como motor de decisión para filtrar y emparejar los mejores combos de vuelo y alojamiento según el presupuesto en MXN.",
          "Desarrollo de un asistente de chat (Pre-planner) y un generador de itinerarios dinámicos basados en geolocalización inteligente.",
        ],
      },
      impactTitle: { en: "Impact / Results", es: "Impacto / Resultados" },
      impacts: {
    ...
    project4: {
      ...
      solutions: {
        en: [
          "Development of a Telegram Bot with multithreaded architecture that separates the user interface, hourly watchlist monitoring, and a proactive deal 'Hunter'.",
          "Implementation of an advanced scraping system with BeautifulSoup to extract prices, images, and 'Lightning Deal' or struck-through 'MSRP' tags.",
          "Integration of Matplotlib to generate visual trend graphs showing price history and highlighting the historical minimum directly in the chat.",
          "Design of robust data persistence with SQLite to manage independent users, price histories, and anti-spam systems.",
        ],
        es: [
          "Desarrollo de un Bot de Telegram con arquitectura multihilo que separa la interfaz de usuario, el monitoreo por hora de la watchlist y un 'Hunter' proactivo de ofertas.",
          "Implementación de un sistema de scraping avanzado con BeautifulSoup para extraer precios, imágenes y etiquetas de 'Oferta Relámpago' o 'MSRP' tachados.",
          "Integración de Matplotlib para generar gráficas de tendencia visuales que muestran el historial de precios y resaltan el mínimo histórico directamente en el chat.",
          "Diseño de una persistencia de datos robusta con SQLite para gestionar usuarios independientes, historiales de precios y sistemas de anti-spam.",
        ],
      },
      impactTitle: { en: "Impact / Results", es: "Impacto / Resultados" },
      impacts: {
